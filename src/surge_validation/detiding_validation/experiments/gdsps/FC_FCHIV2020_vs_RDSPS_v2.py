...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = OrderedDict([
        ("RDSPS (FC, TWL)",
            next((inp_data_root / f"HIV2020_fc_V2").rglob("data_for_scoring_rdsps_FC_fc_H2020_cycles_twl_*")) / "surge_rdsps_FC_fc_H2020_cycles_twl_V2.dat"),
        ("GDSPS (FC, TWL)",
            next((inp_data_root / f"HIV2020_fc_V2").rglob("data_for_scoring_gdsps_FC_fc_H2020_cycles_twl_*")) / "surge_gdsps_FC_fc_H2020_cycles_twl_V2.dat"),
    ])
