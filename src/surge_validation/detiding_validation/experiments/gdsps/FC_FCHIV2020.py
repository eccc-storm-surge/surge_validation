...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = OrderedDict([
        ("GDSPS (FC, TWL)",
            inp_data_root / f"HIV2020_fc/data_for_scoring_gdsps_FC_fc_H2020_cycles_twl_{st_s}_{en_s}" / "surge_gdsps_FC_fc_H2020_cycles_twl.dat"),
    ])
