...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = OrderedDict([
        ("GDSPS (PA, TWL)",
            inp_data_root / f"HIV2020_pa_V1/data_for_scoring_gdsps_pa_fc_H2020_cycles_twl_V1_{st_s}_{en_s}" / "surge_gdsps_pa_fc_H2020_cycles_twl_V1.dat"),
    ])
...
def main():
    ...
    st_date = datetime(2019, 12, 31, 15)
    en_date = datetime(2020, 2, 29, 15)
