...
def fc(station_dict=default_params.station_dict, st_date=None, en_date=None, member_id=""):
    ...
    swl_path_old = inp_data_root + f"data_for_scoring_par_120_{st_s}_{en_s}/surge_par_120.dat"
    swl_path_new = inp_data_root + f"data_for_scoring_par_120_lev_{st_s}_{en_s}/surge_par_120_lev.dat"
