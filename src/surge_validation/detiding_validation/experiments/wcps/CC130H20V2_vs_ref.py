...
EXP_ID = "CC130H20V2_vs_REF_5dmean"
...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = OrderedDict([
        ("REF (FC, TWL)", inp_data_root / f"data_for_scoring_REF_H20_{st_s}_{en_s}" / "surge_REF_H20.dat"),
        ("CC130H20V2 (FC, TWL)", inp_data_root / f"data_for_scoring_CC130H20V2_{st_s}_{en_s}" / "surge_CC130H20V2.dat"),
    ])
