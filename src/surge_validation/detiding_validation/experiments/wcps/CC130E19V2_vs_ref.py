...
EXP_ID = "CC130E19V2_vs_REF_5dmean"
...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = OrderedDict([
        ("REF (FC, TWL)", inp_data_root / f"data_for_scoring_REF_E19_{st_s}_{en_s}" / "surge_REF_E19.dat"),
        ("CC130E19V2 (FC, TWL)", inp_data_root / f"data_for_scoring_CC130E19V2_{st_s}_{en_s}" / "surge_CC130E19V2.dat"),
    ])
