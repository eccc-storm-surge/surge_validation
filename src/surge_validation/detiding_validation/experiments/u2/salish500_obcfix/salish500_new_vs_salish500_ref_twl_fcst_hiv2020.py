...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = OrderedDict([
        ("SALISH500 (FCST-REF, TWL)",
            next(inp_data_root.rglob(f"data_for_scoring_*salish500*_ref_*hiv2020_twl_{st_s}_{en_s}/surge*.dat"))),
        ("SALISH500 (FCST-NEW, TWL)",
            next(inp_data_root.rglob(f"obcfix/data_for_scoring_*salish500*_new_*hiv2020_twl_{st_s}_{en_s}/surge*.dat"))),
    ])
...
def main():
    ...
    EXP_ID = "SALISH500_NEW_vs_SALISH500_REF_FCST_HIV2020_TWL"
