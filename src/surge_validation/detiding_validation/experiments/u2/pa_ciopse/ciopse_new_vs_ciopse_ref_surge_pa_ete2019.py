...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = OrderedDict([
        ("CIOPSE (PA-REF, Surge)",
            next(inp_data_root.rglob(f"data_for_scoring_*ciopse*_ref_*_surge_{st_s}_{en_s}/surge*.dat"))),
        ("CIOPSE (PA-NEW, Surge)",
            next(inp_data_root.rglob(f"data_for_scoring_*ciopse*_new_*_surge_{st_s}_{en_s}/surge*.dat"))),
    ])
...
def main():
    ...
    EXP_ID = "CIOPSE_NEW_vs_CIOPSE_REF_PA_ETE2019_SURGE"
