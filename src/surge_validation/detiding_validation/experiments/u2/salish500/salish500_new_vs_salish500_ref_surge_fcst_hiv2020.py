...
def fc(station_dict=default_params.station_dict,
    ...
    img_dir = Path(f"data/plots/u2_seasonal_cycles/salish500/{label}")
    ...
    exp_id_to_path = OrderedDict([
        ...
        ("SALISH500 (FCST-NEW, Surge)",
            next((inp_data_root / "ciopsw/ss500").rglob(f"data_for_scoring_*salish500*_new_*hiv2020_blend_surge_{st_s}_{en_s}/surge*.dat"))),
    ])
