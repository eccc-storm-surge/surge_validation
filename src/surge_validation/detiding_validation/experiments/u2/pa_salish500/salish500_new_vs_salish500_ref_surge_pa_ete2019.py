...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = OrderedDict([
        ...
        ("SALISH500 (PA-NEW, Surge)",
            next(inp_data_root.rglob(f"data_for_scoring_*salish500*_new_*ete2019_blend_surge_{st_s}_{en_s}/surge*.dat"))),
    ])
...
def main():
    ...
    en_date = datetime(2019, 8, 30, 0)
    EXP_ID = "SALISH500_NEW_vs_SALISH500_REF_PA_ETE2019_SURGE"
