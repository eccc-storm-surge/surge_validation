...
def fc(station_dict=default_params.station_dict, st_date=None, en_date=None):
    ...
    swl_path_old = next(inp_data_root.rglob(f"*{st_s}*{en_s}*/surge_ciopsw_fc_201909_202001.dat"))
    swl_path_new = next(inp_data_root.rglob(f"*{st_s}*{en_s}*/surge_ciopsw_fc_201909_202001.dat"))
