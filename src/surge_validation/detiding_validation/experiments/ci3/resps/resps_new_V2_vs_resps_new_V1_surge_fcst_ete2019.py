...
def main():
    ...
    EXP_ID = "RESPS_NEW_vs_RESPS_REF_FCST_ETE2019_SURGE"
    ...
    fc(station_dict=default_params.get_station_dict(),
       st_date=st_date,
       en_date=en_date,
       exp_id=EXP_ID)
...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = OrderedDict([
        ("RESPS (FCST-NEW-V1, Surge)",
            next((inp_data_root / "resps").rglob(f"data_for_scoring_*resps*_surge_new_{st_s}_{en_s}/surge*.dat"))),
        ("RESPS (FCST-NEW-V2, Surge)",
            next((inp_data_root / "resps").rglob(f"data_for_scoring_*resps*_surge_new_V2_{st_s}_{en_s}/surge*.dat"))),
    ])
    ...
    options = {
        ...
        OptionNames.TALAGRAND_LEADS_LIST: [(0, 24), (48, 72), (96, 120), (144, 168), (168, 192), (192, 216), (216, 240)]
    }
