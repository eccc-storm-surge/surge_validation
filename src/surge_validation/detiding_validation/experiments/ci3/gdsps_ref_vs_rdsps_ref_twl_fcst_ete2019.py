...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = OrderedDict([
        ("RDSPS (FCST-REF, TWL)",
            next((inp_data_root / "rdsps").rglob(f"data_for_scoring_*rdsps*_twl_ref_*{st_s}_{en_s}/surge*.dat"))),
        ("GDSPS (FCST-REF, TWL)",
...
def main():
    ...
    EXP_ID = "GDSPS_REF_vs_RDSPS_REF_FCST_ETE2019_TWL_BV3"
