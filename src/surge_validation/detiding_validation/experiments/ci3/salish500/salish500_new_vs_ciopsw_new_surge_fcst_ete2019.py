...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = OrderedDict([
        ...
        ("SALISH500 (FCST-NEW, Surge)",
            next((inp_data_root / "ciopsw/ss500/").rglob(f"data_for_scoring_*salish500*_new_*ete2019_blend_surge_*/surge*.dat"))),
    ])
...
def main():
    ...
    EXP_ID = "SALISH500_NEW_vs_CIOPSW_NEW_FCST_ETE2019_BLEND_SURGE_redgreen"
