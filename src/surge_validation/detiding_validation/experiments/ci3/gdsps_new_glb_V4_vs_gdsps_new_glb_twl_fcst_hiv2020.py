...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = OrderedDict([
        ...
        ("GDSPS (FCST-NEW-GLB-V4, TWL)",
            next((inp_data_root / "gdsps_glb").rglob(f"data_for_scoring_*gdsps_fcst_FCH20_twl_new_V4_{st_s}_{en_s}/surge*.dat"))),
    ])
...
def main():
    ...
    EXP_ID = "GDSPS_NEW_GLB_V4_vs_GDSPS_NEW_GLB_FCST_HIV2020_TWL"
