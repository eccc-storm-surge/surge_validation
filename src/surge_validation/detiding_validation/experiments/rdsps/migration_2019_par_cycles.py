...
EXP_ID = "migration_rdsps_170par_vs_160ops"
...
def fc(station_dict=default_params.station_dict, st_date=None, en_date=None):
    ...
    inp_data_root = "/home/olh001/Python/loadprogs_python/data/migration_2019_par_cycles/rdsps/"
