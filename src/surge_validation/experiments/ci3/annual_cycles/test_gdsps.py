...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = OrderedDict([
        ...
        ("GDSPS (PA, Surge)",
            Path("/home/olh001/Python/loadprogs_python_experiments/data/test/Fred/data_for_scoring_gdsps_pa_2019-2020_2019070409_2020070103/surge_gdsps_pa_2019-2020.dat")),
    ])
...
def main():
    ...
    EXP_ID = "GDSPS_REF_vs_RDSPS_REF_PA_AC2019-2020_SURGE-test-Fred"
