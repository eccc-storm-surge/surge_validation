...
def main():
    ...
    EXP_ID = "RESPS_NEW_vs_RESPS_REF_FCST_HIV2020_SURGE"
    st_date = datetime(2019, 3, 15, 12)
    en_date = datetime(2020, 3, 15, 12)
...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = OrderedDict([
        ("RESPS (FCST-REF, Surge)",
            next((inp_data_root / "resps").rglob(f"data_for_scoring_*resps*_surge_ref_*{st_s}_{en_s}/surge*.dat"))),
