...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = OrderedDict([
        ("RDSPS (FCST-NEW, Surge)",
            next((inp_data_root / "rdsps/par").rglob(f"data_for_scoring_*rdsps*_surge_new_*{st_s}_{en_s}/surge*.dat"))),
...
def main():
    ...
    EXP_ID = "GDSPS_NEW_vs_RDSPS_NEW_FCST_PAR_SURGE"
