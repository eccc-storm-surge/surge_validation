...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = OrderedDict([
        ...
        ("WCPS_CC1 (FCST-NEW, Surge)",
            next((inp_data_root / "wcps_cc1").rglob(f"data_for_scoring_*WCPS_CC1*_surge_{st_s}_{en_s}/surge*.dat"))),
        ("WCPS_CC1_3a (FCST-NEW, Surge)",
            next((inp_data_root / "wcps_cc1").rglob(f"data_for_scoring_*WCPS_CC1*_surge_v3a_{st_s}_{en_s}/surge*.dat"))),
...
def main():
    ...
    EXP_ID = "WCPS_CC13a_WCPS_CC1_vs_GSL_FCST_ETE2019_SURGE"
