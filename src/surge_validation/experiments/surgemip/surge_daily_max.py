"""
= SURGEMIP daily max surge comparison =
"""
import logging
...
def fc(station_dict=default_params.station_dict,
    ...
    inp_data_root = Path("/home/olh001/Python/surgemip/data/loadprogs/SURGEMIP_SURGE_DAILYMAX/")
    ...
    options = {
        ...
        "b2b_timeseries_min_dt": pd.Timedelta(hours=24),
...
def main():
    ...
    EXP_ID = "SURGEMIP_SURGE_DAILY_MAX_GLOBAL"
    ...
    station_dict = {k: v for k, v in list(station_dict.items()) if k not in ignore}
