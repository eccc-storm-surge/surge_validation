...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = {
        "RESPS (FC, SURGE)": Path(f"/home/olh001/Python/loadprogs_python_experiments/data/ci4/resps/final-cycles/data_for_scoring_resps_prog_surge_new_{st_s}_{en_s}/surge_resps_prog_surge_new.dat"),
        "GESPS (FC2, SURGE)": Path(f"/home/olh001/Python/loadprogs_python_experiments/data/ci4/gesps/final-cycles/regional/data_for_scoring_gesps_prog_surge_new_v2_{st_s}_{en_s}/surge_gesps_prog_surge_new_v2.dat")
    }
    ...
    options = {
        ...
        "b2b_split_seasons": {},
        "score_map_figsize": (20, 15),
        "score_map_marker_size": 120,
...
def main():
    ...
    st_date = datetime(2021, 10, 27, 0)
    en_date = datetime(2022, 6, 14, 00)

    EXP_ID = "GESPS_V001_vs_RESPS_SURGE_EASTCOAST-CI4_FC2"
    ...
    obs_file = Path("/home/olh001/Python/obs_to_grid_mapping/gesps/gesps_east-coast-domain.obs")
