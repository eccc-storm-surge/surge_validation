...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = {
        "RESPS (FC, TWL)": Path(f"/home/olh001/Python/loadprogs_python_experiments/data/ci4/resps/final-cycles/data_for_scoring_resps_prog_twl_new_{st_s}_{en_s}/surge_resps_prog_twl_new.dat"),
        "GESPS (FC2, TWL)": Path(f"/home/olh001/Python/loadprogs_python_experiments/data/ci4/gesps/final-cycles/regional/data_for_scoring_gesps_prog_twl_new_v2_{st_s}_{en_s}/surge_gesps_prog_twl_new_v2.dat")
    }
...
def main():
    ...
    EXP_ID = "GESPS_V001_vs_RESPS_TWL_EASTCOAST-CI4_FC2"
