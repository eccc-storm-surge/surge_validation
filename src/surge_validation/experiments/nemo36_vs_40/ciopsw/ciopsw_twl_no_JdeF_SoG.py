...
EXP_ID = "ciopsw_pa_twl_with_tides_no_JdeF_SoG"
...
def fc(station_dict=default_params.station_dict, st_date=None, en_date=None):
    ...
    exp_id_to_path = {
        ...
        "nemo4_twl": inp_data_root / "data_for_scoring_pa_nep_nemo40_twl_2022070100_2022093000/surge_pa_nep_nemo40_twl.dat",
        "nemo4_rn_csmc_0.2_twl": inp_data_root / "data_for_scoring_pa_nep_nemo4_rn_csmc_0.2_twl_2022070100_2022093000/surge_pa_nep_nemo4_rn_csmc_0.2_twl.dat",
        "nemo4_rn_z0_1e3_twl": inp_data_root / "data_for_scoring_pa_nep_nemo4_rn_z0_1e3_twl_2022070100_2022093000/surge_pa_nep_nemo4_rn_z0_1e3_twl.dat",
        "nemo4_rn_z0_2e3_twl": inp_data_root / "data_for_scoring_pa_nep_nemo4_rn_z0_2e3_twl_2022070100_2022093000/surge_pa_nep_nemo4_rn_z0_2e3_twl.dat",
    }

    b2b_nhours = {
        lbl: 24 for lbl in exp_id_to_path
    }
    b2b_nhours.update({
        "nemo36_twl": 25
    })
