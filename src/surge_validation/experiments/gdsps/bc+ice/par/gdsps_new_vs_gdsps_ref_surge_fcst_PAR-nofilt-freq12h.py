...
def fc(station_dict=default_params.station_dict,
    ...
    inp_data_root = Path("/home/olh001/Python/loadprogs_python_experiments/data/gdsps/baroclinicity+ice/par/freq12h/filt_0/")
...
def main():
    ...
    en_date = datetime(2023, 6, 1, 12)
    EXP_ID = "GDSPS_NEW_vs_GDSPS_REF_FCST_PAR_SURGE_freq12h_nofilt"
