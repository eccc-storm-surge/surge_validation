...
def fc(station_dict=default_params.station_dict,
    ...
    inp_data_root = Path("/home/olh001/Python/loadprogs_python_experiments/data/gdsps/baroclinicity+ice/par")
...
def main():
    ...
    en_date = datetime(2023, 5, 24, 0)
    EXP_ID = "GDSPS_NEW_vs_GDSPS_REF_FCST_PAR_SURGE_ignore_last_6"
