...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = OrderedDict([
        ("GDSPS (PA, Surge)",
            next(inp_data_root.rglob(f"data_for_scoring_*gdsps*_surge_*{st_s}_{en_s}/surge*.dat"))),
    ])
...
def main():
    ...
    EXP_ID = "GDSPS_SURGE_validate_08074"
    ...
    station_dict = io_manager.read_station_dict_from_obs(
        "/home/olh001/Python/download_station_info/data/new_stations_202206_gdsps/new_stations_2.obs")
