...
EXP_ID = "CC130E19V2_lower_visc_vs_REF_5dmean"
...
def fc(station_dict=default_params.station_dict,
    ...
    inp_data_root = Path("/home/olh001/Python/loadprogs_python_experiments/data/wcps_fc_nov_2020")
    ...
    exp_id_to_path = OrderedDict([
        ("REF (FC, TWL)", next(inp_data_root.rglob(f"data_for_scoring_REF_E19_*")) / "surge_REF_E19.dat"),
        ("CC130E19V2_lower_visc (PA, TWL)", inp_data_root / f"data_for_scoring_CC130E19V2_low_visc_{st_s}_{en_s}" / "surge_CC130E19V2_low_visc.dat"),
    ])
