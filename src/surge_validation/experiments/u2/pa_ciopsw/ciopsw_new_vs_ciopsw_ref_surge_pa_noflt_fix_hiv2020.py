...
def fc(station_dict=default_params.station_dict,
    ...
    exp_id_to_path = OrderedDict([
        ...
        ("CIOPSW (PA-NEW-fix, Surge)",
            next(inp_data_root.rglob(f"data_for_scoring_*ciopsw*_new_*blend_surge_fix_noflt_{st_s}_{en_s}/surge*.dat"))),
    ])
...
def main():
    ...
    EXP_ID = "CIOPSW_NEW_vs_CIOPSW_REF_PA_HIV2020_BLEND_SURGE_noflt-fix"
