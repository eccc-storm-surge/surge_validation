...
def fc(station_dict=default_params.station_dict,
    ...
    inp_data_root = Path("/home/olh001/Python/loadprogs_python_experiments/data/u2/ciopsw/ss500")
    ...
    exp_id_to_path = OrderedDict([
        ("SALISH500 (FCST-REF, Surge)",
            next(inp_data_root.rglob(f"data_for_scoring_*salish500*_ref_*ete2019_blend_surge_{st_s}_{en_s}/surge*.dat"))),
        ("SALISH500 (FCST-NEW, Surge)",
            next(inp_data_root.rglob(f"obcfix/data_for_scoring_*salish500*_new_*ete2019_blend_surge_{st_s}_{en_s}/surge*.dat"))),
    ])
...
def main():
    ...
    st_date = datetime(2019, 6, 24, 0)
    en_date = datetime(2019, 8, 31, 00)
    EXP_ID = "SALISH500_NEW_vs_SALISH500_REF_FCST_ETE2019_SURGE"
