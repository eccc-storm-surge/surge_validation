...
EXP_ID = "ciopse_filt_opt_forecast_debias_150day_vs_no"
...
def fc(station_dict=default_params.station_dict, st_date=None, en_date=None):
    ...
    swl_path_old = inp_data_root / "no_debias" / f"data_for_scoring_ciopse_{st_s}_{en_s}" / "surge_ciopse.dat"
    swl_path_new = inp_data_root / "debias_150days" / f"data_for_scoring_ciopse_{st_s}_{en_s}" / "surge_ciopse.dat"

    exp_id_labels = [
        "CIOPSE(FC) (surge)", "CIOPSE(FC-bias150d) (surge)"
    ]
