...
for v in TWL; do
  common_root=$(ls -d ${data_root}/scratch_GESPS_${v}_REFvsGESPS_${v}_NEW_2026020600_2026031800)
  python /home/olh001/Python/surge_validation/src/surge_validation/diagnostics/resps/plot_bss_and_crps.py \
    ...
    --skip-stations 3980 6485 6380 # 9449424 9443090 9452210 9437540 9440581 9441102 9440910
done
