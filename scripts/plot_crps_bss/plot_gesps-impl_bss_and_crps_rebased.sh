...
crps_plot_limits["SURGE"]="0.03 0.2"
# bss_plot_limits["TWL_ETE2019"]="0 1"
# crps_plot_limits["TWL_ETE2019"]="0. 0.2"


  for v in SURGE; do
    common_root=${data_root}/scratch_RESPS_${v}_REFvsGESPS_${v}_NEW_V2_rebased_2021102700_2022061400
    python /home/olh001/Python/surge_validation/src/surge_validation/diagnostics/resps/plot_bss_and_crps.py \
      --paths  ${common_root}/RESPS_${v}_REF \
               ${common_root}/GESPS_${v}_NEW_V2_rebased/ \
      --labels "RESPS (${v}, REF)" "GESPS (${v}, NEW2)" \
      --colors b r --lead_hour_max 312 \
      --out_dir ${common_root} \
      --skip-stations 1970 \
    ...
    --paths ${common_root}/RESPS_${v}_REF/figs/  \
            ${common_root}/GESPS_${v}_NEW_V2_rebased/figs/ \
    --labels "RESPS (${v}, REF)" "GESPS (${v}, NEW2)" \
    --colors b r \
